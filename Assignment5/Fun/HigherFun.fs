...
let rec eval (e: expr) (env: value env) : value =
    ...
    | Call(eFun, eArg) ->
        ...
        | Closure(f, x, fBody, fDeclEnv) ->
            ...
            eval fBody fBodyEnv
        | Clos(s, e, env) ->
            let sVal = eval eArg env
            let fBodyEnv = (s, sVal) :: env
            eval e fBodyEnv
...
let test6comma2a = eval (Fun("x", Prim("*", CstI 2, Var "x"))) []

let test6comma2b =
    eval (Let("y", CstI 22, Fun("z", Prim("+", Var "z", Var "y")))) []
