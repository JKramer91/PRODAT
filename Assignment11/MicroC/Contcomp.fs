...
let rec addCST i C =
    ...
    | (e1, CSTI e2 :: LT :: NOT :: C1) -> if e1 >= e2 then addCST 1 C1 else addCST 0 C1 
    | (e1, CSTI e2 :: LT :: C1) -> if e1 < e2 then addCST 1 C1 else addCST 0 C1
    | (e1, CSTI e2 :: SWAP :: LT :: NOT :: C1) -> if e1 <= e2 then addCST 1 C1 else addCST 0 C1
    | (e1, CSTI e2 :: EQ :: NOT :: C1 ) -> if e1 <> e2 then addCST 1 C1 else addCST 0 C1 
    | (e1, CSTI e2 :: SWAP :: LT :: C1) -> if e1 > e2 then addCST 1 C1 else addCST 0 C1
    | _                     -> CSTI i :: C
...
let addIFZERO lab3 C =
  match C with 
  | (GOTO lab1 :: Label lab2 ::  C1) when lab2 = lab3 -> IFNZRO lab1 :: Label lab2 :: C1 
  | _ -> IFZERO lab3 :: C 
